...
from ansible.module_utils.network.fadcos.fadcos import fadcos_argument_spec, is_global_admin, is_vdom_enable, is_user_in_vdom, get_err_msg
import json
...
def main():
    ...
    if is_vdom_enable(connection) and not module.params['vdom']:
        ...
        result['err_msg'] = 'The user can not accsee the vdom ' + module.params['vdom']
        result['failed'] = True
    else:
