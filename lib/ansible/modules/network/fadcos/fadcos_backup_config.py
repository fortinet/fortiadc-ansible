...
from ansible.module_utils.network.fadcos.fadcos import fadcos_argument_spec
import json
import os
...
def backup_config(module, connection):
    ...
    url = '/api/downloader/config?entire=enable&type=' + module.params['configtype'] + '&password='+pwd
