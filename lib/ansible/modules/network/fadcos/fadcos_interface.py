...
description:
  - Manages interface on FortiADC devices including creating, updating, removing admin objects,
...
from ansible.module_utils.network.fadcos.fadcos import fadcos_argument_spec, is_vdom_enable, get_err_msg, list_to_str, list_need_update, is_global_admin, is_user_in_vdom
import json
