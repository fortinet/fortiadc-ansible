...
description:
  - Manages vdom on FortiADC devices including creating, updating, removing vdom objects,
...
from ansible.module_utils.network.fadcos.fadcos import fadcos_argument_spec, is_vdom_enable, get_err_msg
import json
